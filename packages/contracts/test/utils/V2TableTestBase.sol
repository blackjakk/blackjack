...
abstract contract V2TableTestBase is SeedSearch {
    ...
    function _rules() internal pure virtual returns (BlackjackTableV2.Rules memory) {
    ...
    function gameState(uint256 gameId) internal view returns (BlackjackTableV2.GameState) {
