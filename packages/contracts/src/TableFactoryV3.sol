...
import {BlackjackTableV3} from "./BlackjackTableV3.sol";

/// @title TableFactoryV3
/// @notice Permissionless factory for BlackjackTableV3 variants sharing one chip token
...
contract TableFactoryV3 {
    ...
    function createTable(
        BlackjackTableV3.Rules calldata rules,
        uint256 minWager,
        uint256 maxWager,
        uint256 maxConcurrentGames,
        address admin
